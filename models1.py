...
#     logits = outputs.logits.cpu().detach().numpy()
#     pred_value = np.argmax(logits)
    
#     labels = ['El Mundo Today', 'El País', 'ElDiario.es', 'ElMundo', 'HayNoticia.es']
#     pred = labels[pred_value]
    
#     if pred in ['El País', 'ElDiario.es', 'ElMundo']:
#         pred = 0
#     else:
#         pred = 1
